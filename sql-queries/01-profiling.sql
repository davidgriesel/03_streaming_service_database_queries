...
-- Five of the seven view tables appear to represent enriched entity listings
-- while the remaining two suggest summarised sales data by category and by store.
...
-- RECOMMENDATIONS
-- Remove columns with NULLs, optional information, duplicate functions, dense variables,
-- specialised fields, fields containing duplicates, and any other columns not
-- needed in analysis for removal (Refer 4.3).
...
-- Communicate shared passwords to management as potential security issue (Reporting).
